...
- **Custom reaction set** — let the channel owner pick which Phosphor icons appear in the picker (a settings row of the space) so each channel has its own reaction vocabulary.
