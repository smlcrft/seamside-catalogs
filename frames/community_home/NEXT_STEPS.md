...
2. **Hero image / logo** — Let admins upload a logo + hero background image as files of the space (`Community Home/` through `spaceFiles`, `"data": "write"`, ≤ 8 MiB each), name them in a settings row, and have the worker serve them at the top of the public page.
